...
function removeHeaderNavTransition(){return gsap.timeline().set(".header__navbar",{display:"none"}).set(".header__navbar",{clearProps:"all"},"+=0.2")}document.addEventListener("DOMContentLoaded",function(e){const t=document.querySelector(".header__burger"),a=document.querySelector(".header__navbar"),o=document.body,s=document.querySelectorAll(".header__link"),n=(t.addEventListener("click",()=>{t.classList.toggle("active"),a.classList.toggle("active"),o.classList.toggle("lock")}),s.forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),a.classList.remove("active"),o.classList.remove("lock")})),window.matchMedia("(max-width: 1120px)"));n.addEventListener("change",e=>{e.matches?removeHeaderNavTransition():(removeHeaderNavTransition(),t.classList.remove("active"),a.classList.remove("active"),o.classList.remove("lock"))});var r=document.querySelector(".svg-image-open");const c=document.querySelector(".intro__button--open"),i=gsap.to(r,{rotation:360,ease:"none",duration:20,repeat:-1});c.addEventListener("mouseenter",function(){gsap.to(i,{timeScale:15,duration:.3,ease:Power4.easeOut}),gsap.to(c,.3,{scale:1.2})}),c.addEventListener("mouseleave",function(){gsap.to(i,{timeScale:1,duration:.3,ease:Power4.easeOut}),gsap.to(c,.3,{scale:1})})});