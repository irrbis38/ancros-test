...
function removeHeaderNavTransition(){return gsap.timeline().set(".header__navbar",{display:"none"}).set(".header__navbar",{clearProps:"all"},"+=0.2")}function moveElements(e){var{target:e,offsetX:t}=e,e=e["clientWidth"];const a=t/e-.5;var t=gsap.utils.toArray([".intro__bg--left",".intro__bg--right"]),e=gsap.utils.toArray(".intro__orange"),o=gsap.utils.toArray(".intro__purple");const r=e=>1.2*e+.5;t.forEach((e,t)=>{gsap.to(e,{duration:3,width:Math.abs(87.1+20*a*r(t))+"%",paddingTop:Math.abs(30.5+5*a*r(t))+"%",ease:"Power4.out"})}),e.forEach((e,t)=>{gsap.to(e,{duration:1.8,x:Math.abs(8+20*a*r(t))+"px",y:Math.abs(4+5*a*r(t))+"px",ease:"Power3.out"})}),o.forEach((e,t)=>{gsap.to(e,{duration:3.5,x:Math.abs(2-20*a*r(t))+"px",y:Math.abs(2-10*a*r(t))+"px",ease:"Power3.out"})})}document.addEventListener("DOMContentLoaded",function(e){const t=document.querySelector(".header__burger"),a=document.querySelector(".header__navbar"),o=document.body;var r=document.querySelectorAll(".header__link");t.addEventListener("click",()=>{t.classList.toggle("active"),a.classList.toggle("active"),o.classList.toggle("lock")}),r.forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),a.classList.remove("active"),o.classList.remove("lock")}));window.matchMedia("(max-width: 1120px)").addEventListener("change",e=>{e.matches?removeHeaderNavTransition():(removeHeaderNavTransition(),t.classList.remove("active"),a.classList.remove("active"),o.classList.remove("lock"))});r=document.querySelector(".svg-image-open");const s=document.querySelector(".intro__button--open"),n=gsap.to(r,{rotation:360,ease:"none",duration:20,repeat:-1});s.addEventListener("mouseenter",function(){gsap.to(n,{timeScale:15,duration:.3,ease:Power4.easeOut}),gsap.to(s,.3,{scale:1.2})}),s.addEventListener("mouseleave",function(){gsap.to(n,{timeScale:1,duration:.3,ease:Power4.easeOut}),gsap.to(s,.3,{scale:1})}),document.querySelector(".intro__main").addEventListener("mousemove",moveElements)});