...
function removeHeaderNavTransition(){return gsap.timeline().set(".header__navbar",{display:"none"}).set(".header__navbar",{clearProps:"all"},"+=0.2")}function moveElements(e){var{target:e,offsetX:t}=e,e=e["clientWidth"];const a=t/e-.5;const o=gsap.utils.toArray([".intro__bg--left",".intro__bg--right"]),r=gsap.utils.toArray(".intro__orange"),s=gsap.utils.toArray(".intro__purple"),n=e=>1.2*e+.5;o.forEach((e,t)=>{gsap.to(e,{duration:1.5,width:Math.abs(87.1+20*a*n(t))+"%",paddingTop:Math.abs(30.5+5*a*n(t))+"%",ease:"Power4.out"})}),r.forEach((e,t)=>{gsap.to(e,{duration:1.8,x:Math.abs(8+20*a*n(t))+"px",y:Math.abs(4+5*a*n(t))+"px",ease:"Power3.out"})}),s.forEach((e,t)=>{gsap.to(e,{duration:2.5,x:Math.abs(2-20*a*n(t))+"px",y:Math.abs(2-10*a*n(t))+"px",ease:"Power3.out"})})}document.addEventListener("DOMContentLoaded",function(e){const t=document.querySelector(".header__burger"),a=document.querySelector(".header__navbar"),o=document.body,r=document.querySelectorAll(".header__link"),s=(t.addEventListener("click",()=>{t.classList.toggle("active"),a.classList.toggle("active"),o.classList.toggle("lock")}),r.forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),a.classList.remove("active"),o.classList.remove("lock")})),window.matchMedia("(max-width: 1120px)"));s.addEventListener("change",e=>{e.matches?removeHeaderNavTransition():(removeHeaderNavTransition(),t.classList.remove("active"),a.classList.remove("active"),o.classList.remove("lock"))});var n=document.querySelector(".svg-image-open");const i=document.querySelector(".intro__button--open"),c=gsap.to(n,{rotation:360,ease:"none",duration:20,repeat:-1});i.addEventListener("mouseenter",function(){gsap.to(c,{timeScale:15,duration:.3,ease:Power4.easeOut}),gsap.to(i,.3,{scale:1.2})}),i.addEventListener("mouseleave",function(){gsap.to(c,{timeScale:1,duration:.3,ease:Power4.easeOut}),gsap.to(i,.3,{scale:1})}),document.querySelector(".intro__main").addEventListener("mouseenter",moveElements)});